...
@section('page-content')
    ...
    <div class="bg-white dark:bg-gray-800 text-gray-800 dark:text-white">
        <div class="mx-auto max-w-[88rem] px-4 py-16 sm:px-6 sm:py-16 lg:px-8">
            ...
            <form action="{{ route('backstage.newbook.store') }}" method="POST" role="form">
                @method('POST')
                @csrf
                <div class="space-y-12">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                        <div>
                            <h2 class="text-base font-semibold leading-7 text-gray-900 dark:text-white">建立新書籍資料</h2>
                            <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-300">上架新書資訊以供教師設置指定授課書籍，便於學生能快速選購課程所需書籍。</p>
                        </div>
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-lg dark:bg-slate-900 dark:border-gray-700" data-hs-input-number>
                                        <div class="w-full flex justify-between items-center gap-x-1">
                                            <div class="grow py-2 px-3">
                                                <input value="{{ old('quantity', 1) }}" name="quantity" class="w-full p-0 bg-transparent border-0 text-gray-800 focus:ring-0 dark:text-gray-400 dark:focus:ring-gray-600" type="text" id="quantity" data-hs-input-number-input>
                                            </div>
