...
@section('page-content')
    ...
    <div class="bg-white dark:bg-gray-800 text-gray-800 dark:text-white">
        <div class="mx-auto max-w-[88rem] px-4 py-16 sm:px-6 sm:py-16 lg:px-8">
            ...
            <form action="{{ route('backstage.usedbook.update', $usedbook) }}" method="POST" role="form">
                @method('PATCH')
                @csrf
                <div class="space-y-12">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                        <div>
                            <h2 class="text-base font-semibold leading-7 text-gray-900 dark:text-white">編輯二手書資訊</h2>
                            <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-300">即時更新二手書資訊以供賣家更新二手書資訊，讓使用者能快速選購所需的二手書。</p>
                        </div>
                        ...
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" id="name" name="name" value="{{ old('name', $usedbook -> name ) }}" class=" block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入書籍名稱">
                                </div>
                                @error('name')
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" id="author" name="author" value="{{ old('author', $usedbook -> author ) }}" class=" block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入作者姓名">
                                </div>
                                @error('author')
                                <div class="text-red-400">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" id="pp" name="pp" value="{{ old('pp', $usedbook -> pp) }}" class=" block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入書籍出版項資訊">
                                </div>
                                @error('pp')
                                <div class="text-red-400">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input type="text" id="isbn" name="isbn" value="{{ old('isbn', $usedbook -> isbn) }}" class=" block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入書籍ISBN號碼">
                                </div>
                                @error('isbn')
                                <div class="text-red-400">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <select id="book_state" name="book_state" class="block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                                        ...
                                        <option value="全新" {{ old('book_state', $usedbook -> book_state) == '全新' ? 'selected' : '' }}>全新</option>
                                        <option value="九成新" {{ old('book_state', $usedbook -> book_state) == '九成新' ? 'selected' : '' }}>九成新</option>
                                        <option value="八成新" {{ old('book_state', $usedbook -> book_state) == '八成新' ? 'selected' : '' }}>八成新</option>
                                        <option value="七成新" {{ old('book_state', $usedbook -> book_state) == '七成新' ? 'selected' : '' }}>七成新</option>
                                        <option value="六成新" {{ old('book_state', $usedbook -> book_state) == '六成新' ? 'selected' : '' }}>六成新</option>
                                        <option value="五成新" {{ old('book_state', $usedbook -> book_state) == '五成新' ? 'selected' : '' }}>五成新</option>
                                        <option value="五成新以下" {{ old('book_state', $usedbook -> book_state) == '五成新以下' ? 'selected' : '' }}>五成新以下</option>
                                    </select>
                                </div>
                                @error('book_state')
                                <div class="text-red-400">{{ $message }}</div>
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <input type="text" id="description" name="description" value="{{ old('description', $usedbook -> description) }}" class=" block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入二手書書況">
                                </div>
                                @error('description')
                                <div class="text-red-400">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input type="text" id="book_image" name="book_image" value="{{ old('book_image', $usedbook -> book_image) }}" class=" block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="請輸入二手書書況">
                                </div>
                                @error('book_image')
                                <div class="text-red-400">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mt-2">
                                    <select id="pay_type" name="pay_type" class="block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                                        ...
                                        @foreach($paymentMethods as $paymentMethod)
                                            <option value="{{ $paymentMethod->id }}" {{ old('pay_type', $usedbook -> pay_type) == $paymentMethod->id ? 'selected' : '' }}>
                                                {{ $paymentMethod->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mt-2">
                                    <select id="trade_place" name="trade_place" class="block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                                        ...
                                        @foreach($transactions as $transaction)
                                            <option value="{{ $transaction->id }}" {{ old('trade_place', $usedbook -> trade_place) == $transaction->id ? 'selected' : '' }}>
                                                {{ $transaction->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="date" id="trade_at" name="trade_at" value="{{ old('trade_at', $usedbook -> trade_at) }}" class=" block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                                </div>
                                @error('trade_at')
                                <div class="text-red-400">{{ $message }}</div>
                                @enderror
                                        ...
                                        <select data-hs-select='{
                                          ...
                                          "optionTemplate": "<div><div class=\"flex items-center\"><div class=\"me-2\" data-icon></div><div class=\"text-gray-800 dark:text-gray-200\" data-title></div></div></div>"
                                            ...
                                            @foreach($categories as $category)
                                                <option value="{{ $category->id }}" {{ old('category_id', $usedbook->category_id) == $category->id ? 'selected' : '' }}>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="relative">
                                    <input type="text" id="price" name="price" value="{{ old('price', $usedbook -> price) }}" class="ps-9 pe-16 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="0">
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-lg dark:bg-slate-900 dark:border-gray-700" data-hs-input-number>
                                        <div class="w-full flex justify-between items-center gap-x-1">
                                            <div class="grow py-2 px-3">
                                                <input value="{{ old('status', $usedbook -> status ) }}" name="status" class="w-full p-0 bg-transparent border-0 text-gray-800 focus:ring-0 dark:text-gray-400 dark:focus:ring-gray-600" type="text" id="quantity" data-hs-input-number-input>
                                            </div>
