                    ...
                    <div class="mx-auto max-w-xl px-4 py-16 sm:px-6 sm:py-12 lg:max-w-7xl lg:px-8 ">
                        <div class="px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="bg-gray-50">
                                <div class="mx-auto max-w-2xl pt-10 sm:px-6 sm:py-5 lg:max-w-7xl lg:px-8">
                                        ...
                                        <div class="mt-6">
                                            <div class="space-y-8">
                                                <div class="border-b border-t border-gray-200 bg-white shadow-sm sm:rounded-lg sm:border">
                                                    @foreach($usedbookcarts as $usedbookcart)
                                                    <div class="px-4 py-6 sm:px-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:p-8">
                                                        ...
                                                        <div class="sm:flex lg:col-span-6">
                                                            <div class="aspect-h-1 aspect-w-1 w-full flex-shrink-0 overflow-hidden rounded-lg sm:aspect-none sm:h-40 sm:w-40">
                                                                <img src="{{asset('images/'.$image)}}" alt="Insulated bottle with white base and black snap lid." class="h-full w-full object-cover object-center sm:h-full sm:w-full">
                                                            </div>
