            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="max-w-[85rem] mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-700">
                        <div class="mx-auto max-w-xl px-4 py-16 sm:px-6 sm:py-12 lg:max-w-7xl lg:px-8 ">
                            <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">首頁 - 功能介紹</h2>
                            <p class="mt-4 text-base text-gray-500 dark:text-white">為學校及師生提供更完善的書籍交易網站</p>
